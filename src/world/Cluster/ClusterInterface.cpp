...
void ClusterInterface::Pong(WorldPacket & pck)
{
    printf("Pong /n");
    pingtime = getMSTime();
...
void Player::HandleClusterRemove()
{
    ...
    sEventMgr.AddEvent(this, &Player::Destructor, EVENT_UNK, 10000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT | EVENT_FLAG_DELETES_OBJECT);
